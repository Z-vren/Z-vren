...
I enjoy turning technical ideas into practical systems - whether that means training models, building APIs, designing dashboards, deploying apps, or connecting tools into useful workflows.
...
- Computer Vision
- Data Engineering and Forecasting Systems
- Backend APIs and AI product development
...
- integrations and piece management
- authentication and workspace logic
- frontend, backend, and engine-level concepts
...
- Kafka-based message streaming and partition strategy
- channel management and message history services
- JWT authentication with RSA key flow
- multi-database integration (PostgreSQL, MongoDB, Redis)
- load balancing with Nginx
- Docker-based local orchestration

**Tech used:** Python, FastAPI, Apache Kafka, WebSockets, PostgreSQL, MongoDB, Redis, Docker, Nginx, JWT
...
- AI evaluation and performance analysis
...
- practical NLP for hiring workflows

**Tech used:** Python, NLP, Scikit-learn, TF-IDF, BM25, SBERT
...
- FAZ area segmentation
- U-Net based segmentation workflows
- medical image understanding
- image preprocessing and evaluation
- CycleGAN-related image translation concepts
...
- Combining backend logic, ML models, and frontend interfaces
- Translating research ideas into usable applications
- Debugging and shipping practical AI systems
- Learning new tools quickly and applying them in real projects
...
## Career Goal
I'm focused on building **portfolio-worthy, production-oriented projects** and growing as an:
